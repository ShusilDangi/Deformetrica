/* Deformetrica: This file derives from vtkPolyDataNormals.h in the VTK library */
/* It is disributed under the terms of the Inria Non-Commercial License Agreement */

/*=========================================================================

  Program:   Visualization Toolkit
  Module:    myvtkPolyDataNormals.h
...
=========================================================================*/
// .NAME myvtkPolyDataNormals - compute normals for polygonal mesh
// .SECTION Description
// myvtkPolyDataNormals is a filter that computes point and/or cell normals
...
#ifndef __myvtkPolyDataNormals_h
#define __myvtkPolyDataNormals_h
...
#if (VTK_MAJOR_VERSION > 5)
class VTKFILTERSCORE_EXPORT myvtkPolyDataNormals : public vtkPolyDataAlgorithm
#else
class myvtkPolyDataNormals : public vtkPolyDataAlgorithm
#endif
{
public:
  vtkTypeMacro(myvtkPolyDataNormals,vtkPolyDataAlgorithm);
  ...
  static myvtkPolyDataNormals *New();
...
private:
  myvtkPolyDataNormals(const myvtkPolyDataNormals&);  // Not implemented.
  void operator=(const myvtkPolyDataNormals&);  // Not implemented.
};
