...
public:
	...
	/// Returns the matrices of the type \f[ \frac{\tau_i \tau_j^T}{\left|\tau_i\right|^{1/2}\left|\tau_j\right|^{1/2}} \f], where \f$ \tau_i \f$ denotes the tangents.
	inline VNLMatrixType GetMatrixTangents() const { return m_MatrixTangents; }
...
protected:
	 ...
	 *	\param[out]	MatrixTangents	The matrices \f[ \frac{\tau_i \tau_j^T}{\left|\tau_i\right|^{1/2}\left|\tau_j\right|^{1/2}} \f], where \f$ \tau_i \f$ denotes the tangents.
	 */
	void ComputeCentersTangents(VNLMatrixType& Pts, VNLMatrixType& Centers, VNLMatrixType& Tangents, VNLMatrixType& MatrixTangents);
	...
	/// The matrix \f[ \frac{\tau_i \tau_j^T}{\left|\tau_i\right|^{1/2}\left|\tau_j\right|^{1/2}} \f], where \f$ \tau_i \f$ denotes the tangents.
	VNLMatrixType m_MatrixTangents;
